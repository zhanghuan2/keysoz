...
const Modal = require("pokeball/components/modal"),
    ...
    addToCartTemplate = Handlebars.templates["buyer/goods_detail/templates/cart_tip"],
    activityTemplate = Handlebars.templates["buyer/goods_detail/templates/activity"]
