...
module.exports = ->
  ...
  SellerManageLinkProperty = new Properties.Property @,
    name: "SellerManageLink"
    label: "商家管理链接"
    description: "设置商家管理链接"
    type: "text"
    default: "http://www.zcy.gov.cn/seller/product-manage?step=0"
    useData: true
    reRender: true
  ...
  @registerConfigProperty "ext", HomePageLinkProperty, SellerEnrollLinkProperty, SellerManageLinkProperty, SellerRuleLinkProperty, SellerHelpLinkProperty, HelpCenterLinkProperty, OnlineHelperLinkProperty, ContactUsLinkProperty, TrainingCourseLinkProperty, TrainingPartnerLinkProperty, OnlineLiveLinkProperty, OnlineInquiryLinkProperty, AgreementSupplyLinkProperty, DesignatedServiceLinkProperty, MedicalInstrumentsLinkProperty, VaccineLinkProperty, CommoditiesLinkProperty, HighQualityPavilionLinkProperty, RuleCenterLinkProperty, vaccineNoPermissionHref, blocktradeNoPermissionHref, appCodeProperty
