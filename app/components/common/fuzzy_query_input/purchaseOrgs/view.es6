...
class FuzzyQueryInputPurchaseOrgs {
  ...
  bindQuery () {
    ...
    _self.$el.select2({
      ...
      allowClear: true,
      ajax: {
        url: '/api/fuzzyQuery/queryPurchaseOrgs',
        dataType: 'json',
        delay: 500,
...
module.exports = FuzzyQueryInputPurchaseOrgs