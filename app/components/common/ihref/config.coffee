...
module.exports = ->
  ...
  ifVaccine = new Properties.Property @,
    name: "ifVaccine"
    label: "是否需要权限"
    description: "是否需要权限"
    type: "radio"
  ...
  @registerConfigProperty "ext", showDistrictCodeProperty,ifimgProperty,defaultColorProperty, hoverColorProperty, textProperty, hrefProperty, fontSizeProperty, pageProperty,ifVaccine
