...
const ShopInfoRow = Handlebars.templates["favorite_shop/templates/shopInfoRow"]
const RecommendShops = Handlebars.templates["favorite_shop/templates/recommendShops"]

class FavoriteShop {

  constructor () {
    this.$favoriteShops = $('.favorite-shop')
    this.pageNo = 1
    this.pageSize = 10
    this.preRender()
    this.bindEvents()
