  ...
  UploadFile.prototype = {
    utils: {
      ...
      rowTemplate: function(file, showOnly) {
        return `<div class="fileRow" data-file-id="${file.fileId}"><div class="fileMsg"><i class="icon-zcy icon-fujian"></i><span class="fileName">${file.name}</span>${showOnly? '' : '<a class="deleteFile"><i class="icon-zcy icon-close"></i></a>'}</div></div>`
      }
    },
